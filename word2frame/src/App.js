      ...
      {isLoggedIn ? (
        <div style={{ display: "flex", backgroundColor: "#121212", minHeight: "100vh" }}>
          ...
          <div className="content-spacer" style={{ marginLeft: "240px", flex: 1, position: "relative" }}>
            ...
            >
              <h1 style={{ color: "#FFC759", fontSize: "1.8rem", fontWeight: "700", letterSpacing: "1px" }}>
                WORDS2FRAME
              </h1>
              <button
        ...
        <div className="app-container">
          <div className="clapperboard-container">
            <div className="clapperboard-top">
              ...
              <div className="stripe golden"></div>
              <div className="stripe black"></div>
              <div className="stripe golden"></div>
              <div className="stripe black"></div>
            </div>
              ...
              {showForm ? (
                <form className="login-form" onSubmit={handleAuth}>
                  ...
                  <div className="button-group">
                    <button type="button" className="login-button" onClick={handleGoBack}>
                      Back
                    </button>
                ...
                <>
                  ...
                  <div className="button-group">
                    <button className="login-button" onClick={() => handleShowForm(false)}>
                      Login
                    </button>
                    <button className="signup-button-alt" onClick={() => handleShowForm(true)}>
                      Sign Up
                    </button>
                  </div>
                </>
